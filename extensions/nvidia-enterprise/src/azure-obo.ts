 ...
 * 1. Use the refresh token to silently acquire a token scoped to our app
 ...
 * specific scope. The refresh token can be used to get tokens for other
 * resources, including our own app (aud=AZURE_AD_CLIENT_ID) which is needed
 * for OBO.
 */
 ...
 *
 * This is the main entry point for NFD/Meeting Room/Outlook/People tools.
 */
